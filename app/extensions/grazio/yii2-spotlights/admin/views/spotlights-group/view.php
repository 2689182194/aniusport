...
<div class="slide-view">
    ...
    <p>
        <?= Html::a(Yii::t('app', '修改'), ['update', 'id' => $model->group_id], ['class' => 'btn btn-success']) ?>
        <?= $model->is_deleted == 0 ? Html::a(Yii::t('app', '删除'), ['delete', 'id' => $model->group_id], [
            'class' => 'btn btn-danger',
            'data' => [
                'confirm' => Yii::t('app', '你确定要删除吗?'),
                'method' => 'post',
            ],
        ]) : Html::a(Yii::t('app', '恢复'), ['restore', 'id' => $model->group_id], [
            'class' => 'btn btn-danger',
            'data' => [
